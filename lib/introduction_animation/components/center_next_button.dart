...
//mport 'package:FlyPikes/pages/home_screen.dart';

import '../../pages/home_screen.dart';
import '../../theme.dart';
//import 'package:FlyPikes/theme.dart';
...
class CenterNextButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      padding:
          EdgeInsets.only(bottom: 13 + MediaQuery.of(context).padding.bottom),
      child: Column(
